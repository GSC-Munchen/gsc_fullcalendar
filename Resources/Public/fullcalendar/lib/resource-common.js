    ...
    */
    ...
    var ResourceCell = /** @class */ (function (_super) {
        ...
        ResourceCell.prototype.render = function () {
            ...
            return (common.createElement(ResourceLabelRoot, { resource: props.resource, date: props.date }, function (elRef, customClassNames, dataAttrs, innerElRef, innerContent) { return (common.createElement("th", __assign({ ref: elRef, role: "columnheader", className: ['fc-col-header-cell', 'fc-resource'].concat(customClassNames).join(' '), colSpan: props.colSpan }, dataAttrs),
    ...
    var ResourceDayHeader = /** @class */ (function (_super) {
        ...
        ResourceDayHeader.prototype.buildTr = function (cells, key) {
            ...
            return (common.createElement("tr", { key: key, role: "row" },
